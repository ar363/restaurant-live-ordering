...
kitchen flow:
    when user orders , instantly shows in dashboard , ws connection
    views the order , prepares it , marks it done , bring to table
    if pay at counter chosen , show bill and give option to close order

admin:
    can add menu items , change prices , update kitchen / self password
